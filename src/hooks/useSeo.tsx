...
const seoMetadataMap: Record<string, SeoMetadata> = {
  ...
  compress: {
    ...
    description: "Compress PDF files online for free. Reduce PDF file size without losing quality. Fast, secure PDF compression tool with no watermarks.",
    keywords: "compress PDF, reduce PDF size, PDF compressor, shrink PDF, optimize PDF, PDF file size reducer",
    canonical: "https://convertingpdf.lovable.app/compress",
    ogTitle: "Compress PDF - Free Online PDF Compression",
    ogDescription: "Reduce PDF file size online for free. Compress PDFs without quality loss.",
    ogType: "website",
    twitterTitle: "Compress PDF Files Online Free",
    twitterDescription: "Reduce PDF file size without losing quality. Fast and secure compression.",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "WebApplication",
      "name": "PDF Compressor",
      "description": "Compress PDF files online to reduce file size without quality loss",
  ...
  edit: {
    ...
    description: "Edit PDF files online for free. Add text, images, annotations, and signatures to your PDFs. Professional PDF editing tool with no software installation required.",
    keywords: "edit PDF, PDF editor, online PDF editor, modify PDF, PDF annotation, add text to PDF",
    canonical: "https://convertingpdf.lovable.app/edit",
    ogTitle: "Edit PDF Online - Free PDF Editor",
    ogDescription: "Edit PDFs online for free. Add text, images, and annotations to your documents.",
    ogType: "website",
    twitterTitle: "Edit PDF Files Online Free",
    twitterDescription: "Professional PDF editing tool. Add text, images, and more to your PDFs.",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "WebApplication",
      "name": "PDF Editor",
  ...
  merge: {
    ...
    description: "Merge PDF files online for free. Combine multiple PDFs into one document quickly and securely. No file size limits or watermarks.",
    keywords: "merge PDF, combine PDF, join PDF, PDF merger, merge multiple PDFs, combine PDF files",
    canonical: "https://convertingpdf.lovable.app/merge",
    ogTitle: "Merge PDF Files - Free PDF Combiner",
    ogDescription: "Combine multiple PDF files into one document. Fast, secure, and free.",
    ogType: "website",
    twitterTitle: "Merge PDF Files Online Free",
    twitterDescription: "Combine multiple PDFs into one document quickly and securely.",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "WebApplication",
      "name": "PDF Merger",
  ...
  pdfToJpg: {
    title: "PDF to JPG Converter Online Free - Convert PDF to Image | convertingpdf",
    description: "Convert PDF to JPG online for free. Transform PDF pages into high-quality JPG images. Fast, secure PDF to image conversion with no quality loss.",
    keywords: "PDF to JPG, PDF to image, convert PDF to JPG, PDF to JPEG, PDF image converter",
    canonical: "https://convertingpdf.lovable.app/pdf-to-jpg",
    ogTitle: "PDF to JPG Converter - Free Online Tool",
    ogDescription: "Convert PDF to JPG images online. High-quality conversion, fast and secure.",
    ogType: "website",
    twitterTitle: "Convert PDF to JPG Online Free",
    twitterDescription: "Transform PDF pages into high-quality JPG images instantly.",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "WebApplication",
  ...
  pdfToWord: {
    title: "PDF to Word Converter Online Free - Convert PDF to DOCX | convertingpdf",
    description: "Convert PDF to Word online for free. Transform PDFs to editable DOCX documents. Fast, accurate PDF to Word conversion with preserved formatting.",
    ...
    ogDescription: "Convert PDF to editable Word documents. Fast and accurate conversion.",
    ogType: "website",
    twitterTitle: "Convert PDF to Word Online Free",
    twitterDescription: "Transform PDF files into editable Word documents with preserved formatting.",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "WebApplication",
  ...
  split: {
    ...
    description: "Split PDF files online for free. Extract pages from PDF documents, separate PDFs into multiple files. Fast, secure PDF splitting tool.",
    keywords: "split PDF, extract PDF pages, divide PDF, separate PDF, PDF splitter",
    canonical: "https://convertingpdf.lovable.app/split",
    ogTitle: "Split PDF - Free PDF Splitter Tool",
    ogDescription: "Extract pages from PDF files. Split PDFs into multiple documents quickly.",
    ogType: "website",
    twitterTitle: "Split PDF Files Online Free",
    twitterDescription: "Extract and separate PDF pages into multiple files instantly.",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "WebApplication",
      "name": "PDF Splitter",
